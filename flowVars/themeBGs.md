...
[kaptcha-me-2-modern-classic](https://auth.pingone.com/ee2af24a-1bd3-47b9-b958-506f3bbe0155/as/authorize?response_type=token&client_id=c8b43e50-94e4-4af0-971a-8c2cd61e14e9&redirect_uri=https%3A%2F%2Fhttpbin.org%2Fget&scope=openid%20profile)

### theme names

```
seeingDouble, ahhhhhh, racing, anthroid
```
...
```
// *w/ line breaks added for readability:
...
[kaptcha-me classic](https://auth.pingone.com/ee2af24a-1bd3-47b9-b958-506f3bbe0155/as/authorize?response_type=token&client_id=05db38c4-1555-4a4e-a09b-9baccd1a53ee&redirect_uri=https%3A%2F%2Fhttpbin.org%2Fget&scope=openid%20profile)

```
{ \"0\": {\"name\": \"seeingDouble\", \"src\": \"https://i.ibb.co/yWrB3tt/anthony-double-trouble.png\"}, \"1\": {\"name\": \"ahhhhhh\", \"src\": \"https://i.ibb.co/4dgrH9T/groupphoto3.png\"}, \"2\": {\"name\": \"racing\", \"src\": \"https://i.ibb.co/ystvSH8/race-Track.png\"} , \"3\": {\"name\": \"ping\", \"src\": \"https://i.ibb.co/zsK7Rs1/jewelBG.png\"} }
```
...
```json
{
  ...
  '2': { name: 'racing', src: 'https://i.ibb.co/ystvSH8/race-Track.png' },
  '3': { name: 'ping', src: 'https://i.ibb.co/zsK7Rs1/jewelBG.png' }
}
```
...
```json
{
  ...
  "1": {
    "name": "ahhhhhh",
    "src": "https://i.ibb.co/4dgrH9T/groupphoto3.png"
  },
  "2": {
    "name": "racing",
    "src": "https://i.ibb.co/ystvSH8/race-Track.png"
  },
  "3": {
    "name": "ping",
    "src": "https://i.ibb.co/zsK7Rs1/jewelBG.png"
  }
}
```
